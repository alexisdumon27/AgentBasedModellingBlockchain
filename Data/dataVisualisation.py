...
for i in range(12):
    new_index = exchange_rates.index[exchange_rates['date'] == "2020-01-14 23:00:00"].tolist()
...
###### First Two weeks Percent change = ((new - old) / old) * 100
# for i in range(12):
#     old = exchange_rates[symbols[i]].iloc[0]
...
# for i in range(12):
#     end_index = exchange_rates.index[exchange_rates['date'] == "2020-01-14 23:00:00"].tolist()
...
### Difference between min and max FIRST TWO WEEKS
# for i in range(12):
#     end_index = exchange_rates.index[exchange_rates['date'] == "2020-01-14 23:00:00"].tolist()
#     data = exchange_rates[symbols[i]].iloc[0:end_index[0]]
#     min_index = data.idxmin()
...
#### Standard deviation first two weeks
# for i in range(12):
#     # normalise
#     new_index = exchange_rates.index[exchange_rates['date'] == "2020-01-14 23:00:00"].tolist()
