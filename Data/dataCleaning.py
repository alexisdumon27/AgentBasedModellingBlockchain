...
exchange_rates_df_no_usd_no_math = pd.read_csv("./cleanedDatafiles/cleanedJoinedExchangeRates-noMath.csv")
...
btc_usd_daily = pd.read_csv('./cleanedDatafiles/cleanedBTCUSD.csv', index_col=0)
...
# exchange_rate_with_btc_usd = pd.read_csv("exchange_rates.csv", index_col= None)

print (exchange_rate_with_btc_usd.shape[0])

final_df = exchange_rate_with_btc_usd.loc[0:exchange_rate_with_btc_usd.shape[0]:60]
final_df.reset_index(drop = True, inplace= True)

# SAVES THE FILE
final_df.to_csv("exchange_rates.csv")